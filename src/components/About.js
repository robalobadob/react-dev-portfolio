  ...
  return (
    <section id="about">
      <div className="container mx-auto flex px-10 py-20 md:flex-row flex-col items-center">
        ...
        <p className="sm:text-3xl mb-2 font-medium">
            Hi there! 👋  My name is
          </p>
          <h1 className="mb-8 text-5xl sm:text-6xl lg:text-8xl text-caput">
             Rob Hoover
          </h1>
          ...
          <div className="flex justify-center">
            <a
              href="#contact"
              className="inline-flex bg-npb border-0 py-2 px-6 focus:outline-none hover:bg-blue-300 rounded text-lg text-center">
              Work With Me
            </a>
          </div>
        </div>
